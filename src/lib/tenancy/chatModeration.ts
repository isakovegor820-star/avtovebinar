...
export async function listModerationSessions(db: PrismaClient, context: TenantContext, input: unknown) {
...
export async function listModerationMessages(db: PrismaClient, context: TenantContext, sessionIdInput: unknown) {
