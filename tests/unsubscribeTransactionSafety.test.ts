...
vi.mock('../src/lib/prisma.js', () => {
  ...
  prisma.$transaction.mockImplementation(async (callback: ((tx: typeof prisma) => unknown) | Array<Promise<unknown>>) =>
...
beforeEach(() => {
  ...
  prismaMock.$transaction.mockImplementation(async (callback: ((tx: typeof prismaMock) => unknown) | Array<Promise<unknown>>) =>
