    ...
    if (duplicate) {
      return {
        ...
        classification: {
          ...
          requiresHuman: duplicate.intent === 'legal_question' || duplicate.intent === 'manager_contact' || duplicate.urgency === 'high',
        },
        replayed: true,
      };
    }
...
export async function listTelegramConsultantMessages(
  db: PrismaClient,
